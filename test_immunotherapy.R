...
save(gse115978, file='/Users/juyoung/Desktop/singlecell_jy/data/gse115978.rda')
...
gse115978$sample=gse115978_cell_annotations$samples #추가
gse115978$cancer_type=rep('melanoma',ncol(gse115978))#추가
...
melanoma$nFeature_RNA
VlnPlot(melanoma, features = 'nFeature_RNA')
...
##############################
# 추가 요청(sample별 구분, 어떤 암인지, 어떤 sample인지도 )
...
VlnPlot(gse115978_fu, features = c("nFeature_RNA", "nCount_RNA"), ncol = 2)
